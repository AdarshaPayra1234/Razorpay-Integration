...
app.post('/api/admin/webauthn/generate-registration-options', authenticateAdmin, webauthnRateLimit, async (req, res) => {
  try {
    ...
    // REMOVE THE MANUAL CRYPTO.RANDOMBYTES CODE - simplewebauthn handles challenge generation internally
    // The challenge is already generated by generateRegistrationOptions()
